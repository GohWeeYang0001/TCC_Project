			...
			<div class="view-product">
				<div class="company_identify">
					<div class="manage-head">
						<h6 class="padding-left manage-head-con">Edit Clothes</h6>
					</div>
					<form id="clothes-edit-form" action="Backend/clothes_edit_process.php" method="post" autocomplete="off">
					<?php
						$id=$_GET['id'];
						$query_c = $con->query('SELECT * FROM clothes WHERE clothes_id="'.$id.'"');
							...
							<div class="unit-style padding-big-lr clearfix pd-b-20">
								...
								<div class="real-name-con height-main margin-top-25 clearfix">
									...
									<div class="content-right-zoon">
										<input class="width-main input" type="text" datatype="*" name="clothes_id" value="<?php echo $row_c["clothes_id"];?>" disabled>
										<input class="width-main input" type="hidden" datatype="*" name="clothes_id" value="<?php echo $row_c["clothes_id"];?>">
									</div>
								</div>
								<div class="real-name-con height-main margin-top-25 clearfix">
									<p class="content-left-zoon">
									...
									<div class="content-right-zoon">
										<input class="width-main input" type="text" datatype="*" name="clothes_name" value="<?php echo $row_c["clothes_name"];?>">
									</div>
								</div>
								<div class="real-name-con height-main margin-top-25 clearfix">
									<p class="content-left-zoon">
									...
									<div class="content-right-zoon">
										...
										?>
											<option 
												...
												<?php echo ($row_c["clothes_type"] == $row_ct["clothes_type_id"]) ? 'selected' : ''; ?>
											>
									...
									<div class="content-right-zoon">
										...
										?>
											<option 
												...
												<?php echo ($row_c["clothes_brand"] == $row_cb["clothes_brand_id"]) ? 'selected' : ''; ?>
											>
								...
								<div class="real-name-con height-main margin-top-25">
									...
									<div class="content-right-zoon">
										<div class="laydate-box fl">
											<input class="input hd-input" type="text" name="clothes_price" value="<?php echo $row_c["clothes_price"];?>"/>
										</div>
									</div>
								</div>
								<div class="real-name-con height-main margin-top-25">
									...
									<div class="content-right-zoon">
										<div class="laydate-box fl">
											<input class="input hd-input" type="number" name="clothes_stock" value="<?php echo $row_c["clothes_stock"];?>" min="0" max="9999" />
										</div>
									</div>
								</div>
							</div>
					...
					?>
						<div class="unit-style padding-large-tb clearfix" style="margin: 0 20px;">
							<div class="margin-large-top text-left content-left-zoon">
								<input type="submit" value="Update" name="submit" class="submit fl">
							</div>
						</div>
					</form>
				</div>
